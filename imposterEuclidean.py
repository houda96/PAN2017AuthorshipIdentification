...
def imposterFunc(doc1Feats, doc2Feats, imposters, amountRuns, amountFeatures, cv_fit,
	...
	for setVal in featureSets:
		...
		sim = euclideanSquaredNormalized(useDoc1, useDoc2)
		for impost in impostersDoc1:
			sim1 = euclideanSquaredNormalized(useDoc1, impost[setVal:setVal+amountFeatures])
			if sim > sim1:
				score += 1
		for impost in impostersDoc2:
			sim1 = euclideanSquaredNormalized(useDoc2, impost[setVal:setVal+amountFeatures])
			if sim > sim1:
				score += 1
