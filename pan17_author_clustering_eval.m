% PAN-2017 evaluation scrpipt for the author clustering task
% for Octave 3.8.2
...
for i=1:numel(INFO)
    ...
    [R,P,F]=pan17_bcubed(TRUE_CLUSTERING,RUN_CLUSTERING);
    AP=pan17_avg_precision(TRUE_RANKING,RUN_RANKING);
    MAP=[MAP,AP];
    MF=[MF,F];
