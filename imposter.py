...
if __name__ == "__main__":
	...
	# 1 -> hogere threshold
	#applyImposter(firstPath, outputPath + "1/", 0.3, 100, option, 300, 4, "char", 25)
	#print("1 klaar")
	# 2 -> meer runs
	#applyImposter(firstPath, outputPath + "2/", 0.2, 150, option, 300, 4, "char", 25)
	#print("2 klaar")
	# 3 -> minder imposters
	applyImposter(firstPath, outputPath + "3/", 0.2, 100, option, 300, 4, "char", 15)
	print("3 klaar")
