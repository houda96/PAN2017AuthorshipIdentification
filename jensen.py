...
def applyJSD(firstPath, outputPath, threshold, option, k, n, mode):
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("jensen.py -i EVAL_DIRECTORY -o OUTPUT_DIRECTORY")
    firstPath = sys.argv[2]
    outputPath = sys.argv[4]
    option = "top"
    applyJSD(firstPath, outputPath, 6, option, 300, 4, "char")
    # nVals = [5, 6]
    ...
    #             applyJSD(firstPath, newPath, thresholds[e-1], option, k, n, "char")
    #             newPath1 = outputPath + "n" + str(n) + "w/k" + str(k)
    #             newPath1 += "/experiment" + str(e) + "/"
    #             applyJSD(firstPath, newPath1, thresholds[e-1], option, k, n, "word")
